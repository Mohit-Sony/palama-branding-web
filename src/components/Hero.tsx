  ...
  return (
    <section className="relative pt-20 pb-8 sm:pt-24 sm:pb-12 md:pt-32 md:pb-16 overflow-hidden bg-white">
      <div className="max-w-(--spacing-container) mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="relative max-w-[1100px] mx-auto px-2 sm:px-4 mt-6 md:mt-16">
          ...
          <div className="relative w-full flex justify-start items-center pb-6 sm:pb-10 md:pb-16">
            {/* Desktop Image */}
            <div className="relative z-10 w-[88%] md:w-[85%] rounded-xl md:rounded-2xl overflow-hidden shadow-2xl border border-gray-100 bg-white transition-transform duration-1000 ease-out hover:-translate-y-2">
              <Image
